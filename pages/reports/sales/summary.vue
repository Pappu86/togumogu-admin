...
export default {
  ...
  data() {
    return {
      ...
      main_headers: [
        { text: 'Group Type', value: 'group_type' },
        { text: 'Total Order Quantity', value: 'total_order_quantity' },
        { text: 'Total Product Quantity', value: 'total_product_quantity' },
        ...
        { text: 'Delivery Cost', value: 'shipping_cost' },
        { text: 'Total Sale Price', value: 'total_sale_price' },
        { text: 'Total Gross Revenue', value: 'total_gross_revenue' },
      ],
  ...
  methods: {
    // get summary by pagination
    getProductsByPagination: debounce(async function () {
      this.loading = true;
      let url = `groupType=summary&page=${this.pagination.page}&per_page=${this.pagination.itemsPerPage}`;
